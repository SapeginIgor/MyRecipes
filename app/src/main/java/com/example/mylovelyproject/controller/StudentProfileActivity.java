...
public class StudentProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            if (!isForEditing) {
                getSupportActionBar().setTitle("Добавить ингредиент");
            } else {
                getSupportActionBar().setTitle("Изменить ингредиент");
            }
        ...
        if (isForEditing) {
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    dateEditText.setText(student.getDateofbirth());
                });
            }).start();
        }
        ...
        saveButton.setOnClickListener((v) -> {
            ...
            student.setDateofbirth(dateEditText.getText().toString());
